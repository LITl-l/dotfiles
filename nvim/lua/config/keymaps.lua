...
-- Toggle options
map("n", "<leader>uf", require("config.util").toggle_format_on_save, { desc = "Toggle format on Save" })
...
map("n", "<leader>ul", function() vim.opt.list = not vim.opt.list:get() end, { desc = "Toggle List Chars" })
map("n", "<leader>un", function() vim.opt.number = not vim.opt.number:get() end, { desc = "Toggle Line Numbers" })
map("n", "<leader>ur", function() vim.opt.relativenumber = not vim.opt.relativenumber:get() end, { desc = "Toggle Relative Numbers" })
